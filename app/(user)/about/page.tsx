        ...
        <div className='max-w-screen-xl px-4 md:px-8 mx-auto'>
          ...
          <div className='mb-10 md:mb-16'>
            ...
            <p className='max-w-screen-md text-gray-500 md:text-lg text-center mx-auto'>
              My name is Grant Gariepy and I've been building full stack apps for almost 2 years and
              love to learn and experiment with anything coding related. Check out my Github,
