    ...
    <>
      <div>
        <div className='bg-white pb-6 sm:pb-8 lg:pb-12'>
          <div className='max-w-screen-2xl px-4 md:px-8 mx-auto'></div>
          <section className='min-h-96 flex justify-center items-center flex-1 shrink-0 bg-gray-100 overflow-hidden shadow-lg relative py-16 md:py-20 xl:py-48'>
            {/* <!-- overlay - start --> */}
            ...
            <div className='sm:max-w-xl flex flex-col items-center relative p-4'>
              ...
              <h1 className='text-white text-4xl sm:text-5xl md:text-6xl font-bold text-center mb-8 md:mb-12'>
                Your one stop shop for all your Cryptocurrency information
              </h1>

              <div className='w-full flex flex-col sm:flex-row sm:justify-center gap-2.5'>
                <label
                  htmlFor='my-drawer'
                  className='inline-block drawer-button bg-gray-200 hover:bg-gray-300 focus-visible:ring ring-indigo-300 text-gray-500 active:text-gray-700 text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3'
                >
                  Take tour
                </label>
              </div>
          ...
          <div className='bg-white py-6 sm:py-8 lg:py-12'>
            <div className='max-w-screen-2xl px-4 md:px-8 mx-auto'>
              ...
              <div className='sm:h-40 grid grid-cols-2 md:grid-cols-4 sm:content-evenly bg-indigo-100 rounded-lg gap-6 p-6'>
                {/* <!-- logo - start --> */}
                ...
                <div className='flex justify-center text-indigo-500'>
                  ...
                  <p className='text-3xl font-bold'>Trypescript</p>
                </div>
                {/* <!-- logo - end --> */}
                ...
                <div className='flex justify-center text-indigo-500'>
                  ...
                  <p className='text-3xl font-bold'>TailwindCSS</p>
                </div>
                {/* <!-- logo - end --> */}
                ...
                <div className='flex justify-center text-indigo-500'>
                  ...
                  <p className='text-3xl font-bold'>Vercel</p>
                </div>
                {/* <!-- logo - end --> */}
              </div>
            </div>
          ...
          <div className='bg-white py-6 sm:py-8 lg:py-12'>
            <div className='max-w-screen-2xl px-4 md:px-8 mx-auto'>
              ...
              <div className='grid sm:grid-cols-2 xl:grid-cols-2 gap-8 md:gap-12 xl:gap-16'>
                {/* <!-- feature - start --> */}
                <div className='flex gap-4 md:gap-6'>
                  ...
                  <div>
                    <h3 className='text-lg md:text-xl font-semibold mb-2'>Next.js 13</h3>
                    <p className='text-gray-500 mb-2'>
                      Built with Next.js 13 and React making use of new features
                    </p>
                    {/* <a
                      href='#'
      ...
      <!-- feature - start --> */}
                <div className='flex gap-4 md:gap-6'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-500 mb-2'>
                      Written in Typescript to ensure type safety through the entire codebase
                    </p>
                    {/* <a
                      href='#'
                      className='text-indigo-500 hover:text-indigo-600 active:text-indigo-700 font-bold transition duration-100'
      ...
      <!-- feature - start --> */}
                <div className='flex gap-4 md:gap-6'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-500 mb-2'>
                      Deployed via Vercel for a quick and reliable backend
                    </p>
                    {/* <a
                      href='#'
                      className='text-indigo-500 hover:text-indigo-600 active:text-indigo-700 font-bold transition duration-100'
      ...
      <!-- feature - start --> */}
                <div className='flex gap-4 md:gap-6'>
                  ...
                  <div>
                    <h3 className='text-lg md:text-xl font-semibold mb-2'>Tailwind CSS</h3>
                    <p className='text-gray-500 mb-2'>
                      Designed with Tailwind for a clean and modern design
                    </p>
                    {/* <a
                      href='#'
                      className='text-indigo-500 hover:text-indigo-600 active:text-indigo-700 font-bold transition duration-100'
